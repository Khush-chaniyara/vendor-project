...
$invQuery = "
    ...
    WHERE i.invoice_id = $invoice_id AND p.generated_by = $user_id
";
$invResult = mysqli_query($conn, $invQuery);

if (mysqli_num_rows($invResult) == 0) {
    echo "<div class='alert alert-warning m-4'>Invoice not found or you do not have permission to view it.</div>";
    include 'footer.php'; exit();
}
...
<div class="d-flex justify-content-between align-items-center mb-4 no-print">
    ...
    <div>
        <button onclick="window.print()" class="btn btn-primary shadow-sm" style="background-color: #0c8599; border:none;"><i class="bi bi-printer"></i> Save as PDF</button>
    </div>
</div>
...
<div class="card shadow-sm border-0" id="print-area">
    <div class="card-body p-5">
        ...
        <div class="row pb-4 mb-4" style="border-bottom: 2px solid #0c8599;">
            <div class="col-sm-6">
                <h2 class="fw-bold mb-0" style="color: #0c8599;"><i class="bi bi-buildings"></i> VendorBridge</h2>
